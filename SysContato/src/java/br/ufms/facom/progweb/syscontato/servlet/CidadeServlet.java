...
public class CidadeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Estado estado = estadoJpaController.findEstado(Integer.parseInt(request.getParameter("idEstado")));
        List<Cidade> cidades = estado.getCidadeList();

        String options = "";
        for(Cidade cidade : cidades) {
             options += "<option value=\"" + cidade.getIdCidade() + "\">" + cidade.getNome() + "</option>\n";
        }
