...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <c:if test="${read == 0}">
        ...
        <form action="ContatoCRUDServlet" method="post">
            ...
            <label for="operadoraCel">Operadora:</label><span>${contato.operadoraCel}</span><br />
            ...
            <br />
            <input type="image" src="img/view.png" width="64" height="64" title="Voltar" class="box" onclick="window.history.go(-1)" />
        </form>
